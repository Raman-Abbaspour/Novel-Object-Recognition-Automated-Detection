...
# def get_model(fn_que):
#     PATH_TO_SAVED_MODEL = "saved_model"
#
#     w = tf.saved_model.load(PATH_TO_SAVED_MODEL)
#     x= [w]
#     fn_que.put(x)
#     a = fn_que.empty()
#     time.sleep(2)
...
#     a= fn_que.empty()
#     if a:
#         root.after(900, check_fn)
#         print("still checking")
#     else:
#         print(f"done checking {a}")
#         global detect_fn
#         detect_fn = fn_que.get()
...
if __name__ == "__main__":
    ...
    # thread.start()
    fn_que = mQueue()  # multiprocessing.Value("d")

    # multiprocessing.Process(target=get_model, args=(fn_que,)).start()
